...
const CENTRES = [
  { id:'oatley',           name:'Oatley',           ownaName:'Oatley',           floatUnitIds:[224], issUnitIds:[230], leaveUnitIds:[134,142,139], nonRatioUnitIds:[130,131,197,165,141,235,324,337], rooms:[{id:213,ownaRoomName:'0-1 Room',ratio:4},{id:132,ownaRoomName:'1-2 Room',ratio:4},{id:133,ownaRoomName:'2-3 Room',ratio:5},{id:196,ownaRoomName:'2.5-3.5 Room',ratio:5},{id:159,ownaRoomName:'3-4 Room',ratio:10},{id:223,ownaRoomName:'3.5-5 Room',ratio:10}] },
  ...
  { id:'spring-farm',      name:'Spring Farm',       ownaName:'Spring Farm',      floatUnitIds:[270], issUnitIds:[278], leaveUnitIds:[272,273,275], nonRatioUnitIds:[263,264,277,271,311,325,338,279], rooms:[{id:265,ownaRoomName:'0-1',ratio:4},{id:266,ownaRoomName:'1-2',ratio:4},{id:267,ownaRoomName:'2-3',ratio:5},{id:269,ownaRoomName:'3-5',ratio:10}] },
  { id:'denham-court',     name:'Denham Court',      ownaName:'Denham Court',     floatUnitIds:[252], issUnitIds:[260], leaveUnitIds:[254,448,257], nonRatioUnitIds:[245,246,259,253,301,320,333,261], rooms:[{id:247,ownaRoomName:'0-1',ratio:4},{id:248,ownaRoomName:'1-2',ratio:4},{id:300,ownaRoomName:'2-3 Room 1',ratio:5},{id:249,ownaRoomName:'2-3 Room 2',ratio:5},{id:250,ownaRoomName:'3-4',ratio:10},{id:251,ownaRoomName:'4-5',ratio:10}] },
...
export default async function handler(req, res) {
  ...
  for (const centre of centres) {
    ...
    results.push({
      ...
      floatSurplus,
      surplusVal,
      debug: { roomData, totalFloorStaff, totalRatioShortage, totalSurplus, netShortageAfterRealloc, bufferRequired, roomNetSurplus, effectiveFloatCount, centreRosterCount: centreRosters.length, unitCounts, matchesPerRoom, roomIds: centre.rooms.map(r=>r.id) },
    });
  }
