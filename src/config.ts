...
export const CENTRES: Centre[] = [
  ...
  },
  {
    ...
    approvedPlaces: 68,
    rooms: [
      { id: 'sf_0_1', name: '0-1 Explorers',   ageGroup: '0-1 yrs', ratio: 4,  deputyUnitId: 265, ownaRoomName: 'Explorers' },
      { id: 'sf_1_2', name: '1-2 Adventurers', ageGroup: '1-2 yrs', ratio: 4,  deputyUnitId: 266, ownaRoomName: 'Adventurers' },
      { id: 'sf_2_3', name: '2-3 Voyagers',    ageGroup: '2-3 yrs', ratio: 5,  deputyUnitId: 267, ownaRoomName: 'Voyagers' },
      { id: 'sf_3_5', name: '3-5 Achievers',   ageGroup: '3-5 yrs', ratio: 10, deputyUnitId: 269, ownaRoomName: 'Achievers' },
    ],
    floatUnitIds:    [270],
    issUnitIds:      [278],
  ...
  },
  {
    ...
    approvedPlaces: 109,
    rooms: [
      { id: 'dc_0_1',  name: '0-1 Explorers',   ageGroup: '0-1 yrs', ratio: 4,  deputyUnitId: 247, ownaRoomName: 'Explorers' },
      { id: 'dc_1_2',  name: '1-2 Adventurers', ageGroup: '1-2 yrs', ratio: 4,  deputyUnitId: 248, ownaRoomName: 'Adventurers' },
      { id: 'dc_2_3a', name: '2-3 Pioneers',    ageGroup: '2-3 yrs', ratio: 5,  deputyUnitId: 300, ownaRoomName: 'Pioneers' },
      { id: 'dc_2_3b', name: '2-3 Voyagers',    ageGroup: '2-3 yrs', ratio: 5,  deputyUnitId: 249, ownaRoomName: 'Voyagers' },
      { id: 'dc_3_4',  name: '3-4 Creators',    ageGroup: '3-4 yrs', ratio: 10, deputyUnitId: 250, ownaRoomName: 'Creators' },
      { id: 'dc_4_5',  name: '4-5 Achievers',   ageGroup: '4-5 yrs', ratio: 10, deputyUnitId: 251, ownaRoomName: 'Achievers' },
    ],
    floatUnitIds:    [252],
    issUnitIds:      [260],
