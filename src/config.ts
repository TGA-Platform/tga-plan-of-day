...
export const CENTRES: Centre[] = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'dc_2_3a', name: '2-3 Pioneers',    ageGroup: '2-3 yrs', ratio: 5,  deputyUnitId: 300, ownaRoomName: '2-3 Room 1' },
      { id: 'dc_2_3b', name: '2-3 Voyagers',    ageGroup: '2-3 yrs', ratio: 5,  deputyUnitId: 249, ownaRoomName: '2-3 Room 2' },
      { id: 'dc_3_4',  name: '3-4 Creators',    ageGroup: '3-4 yrs', ratio: 10, deputyUnitId: 250, ownaRoomName: '3-4' },
      { id: 'dc_4_5',  name: '4-5 Achievers',   ageGroup: '4-5 yrs', ratio: 10, deputyUnitId: 251, ownaRoomName: '4-5' },
    ],
    floatUnitIds:    [252],
    issUnitIds:      [260],
