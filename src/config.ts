...
export const CENTRES: Centre[] = [
  ...
  },
  {
    ...
    approvedPlaces: 92,
    rooms: [
      { id: 'bx_0_2',  name: '0-2 Explorers',   ageGroup: '0-2 yrs', ratio: 4,  deputyUnitId: 113, ownaRoomName: 'Explorers' },
      { id: 'bx_2_3',  name: '2-3 Adventurers', ageGroup: '2-3 yrs', ratio: 5,  deputyUnitId: 125, ownaRoomName: 'Adventurers' },
      { id: 'bx_3_4a', name: '3-4 Voyagers',    ageGroup: '3-4 yrs', ratio: 10, deputyUnitId: 115, ownaRoomName: 'Voyagers' },
      { id: 'bx_3_4b', name: '3-4 Creators',    ageGroup: '3-4 yrs', ratio: 10, deputyUnitId: 121, ownaRoomName: 'Creators' },
      { id: 'bx_4_5',  name: '4-5 Achievers',   ageGroup: '4-5 yrs', ratio: 10, deputyUnitId: 114, ownaRoomName: 'Achievers' },
    ],
    floatUnitIds:    [181],
    issUnitIds:      [226],
