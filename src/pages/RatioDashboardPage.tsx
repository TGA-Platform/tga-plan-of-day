...
export default function RatioDashboardPage() {
  ...
  const [activeView, setActiveView]   = useState<'plan-of-day' | 'ratio-check' | 'summary' | 'roster'>('plan-of-day');
                ...
                <div className="space-y-0">
                  {effectiveSupportStaff.map(s => (
                    ...
                    >
                      <StaffChip staff={s} />
                      <div className="flex items-center gap-1 ml-2 flex-shrink-0">
                        {/* Plan Day available for all support staff (directors, ed leaders etc may cover lunches) */}
                        <button
