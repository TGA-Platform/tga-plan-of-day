...
export const COMPLIANCE_REQUIREMENTS: ComplianceRequirement[] = [
  // Certifications (with expiry dates)
  {
    ...
    requiredFor: ['Centre Director', 'Assistant Director', 'Educational Leader', 'Room Leader', 'Early Childhood Teacher', 'Educator', 'Educator Casual', 'Float', 'Internal Casual', 'Trainee', 'Childcare Trainee', 'Diploma Educator', 'Centre Support', 'Chef', 'ISS Support Worker'],
  ...
  },
  {
    ...
    category: 'certification',
    requiredFor: ['Centre Director', 'Assistant Director', 'Educational Leader', 'Room Leader', 'Early Childhood Teacher', 'Educator', 'Educator Casual', 'Float', 'Internal Casual'],
  ...
  },
  {
    ...
    category: 'certification',
    requiredFor: ['Centre Director', 'Assistant Director', 'Educational Leader', 'Room Leader', 'Early Childhood Teacher', 'Educator', 'Educator Casual', 'Float', 'Internal Casual', 'Trainee', 'Childcare Trainee'],
  ...
  // Documents (no expiry)
  {
    ...
    category: 'document',
    requiredFor: ['Centre Director', 'Assistant Director', 'Educational Leader', 'Room Leader', 'Early Childhood Teacher', 'Educator', 'Educator Casual', 'Float', 'Internal Casual', 'Trainee', 'Childcare Trainee', 'Diploma Educator'],
  ...
  },
  {
    ...
    category: 'document',
    requiredFor: ['Trainee', 'Childcare Trainee'],
