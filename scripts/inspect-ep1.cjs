...
async function main() {
  ...
  const centre = {
    id: 'ed-park-1', name: 'Ed Park 1', rooms: [
      { name: '0-1 Explorers', ownaRoomName: '0-1 Room' },
      { name: '1-2 Adventurers', ownaRoomName: '1-2 Room' },
      { name: '2-3 Voyagers', ownaRoomName: '2-3 Room' },
      { name: '3-4 Creators', ownaRoomName: '3-4 Room' },
      { name: '4-5 Achievers', ownaRoomName: '4-5 Room' },
    ]
  };
